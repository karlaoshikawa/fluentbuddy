...
export const EXERCISE_BANK: Exercise[] = [
  ...
  // A1 - Escrita básica
  {
    ...
    level: 'A1',
    category: 'writing',
    question: 'Escreva sobre você (nome, idade, onde mora):',
    maxWords: 20,
  ...
  
  {
    ...
    level: 'A1',
    category: 'writing',
    question: 'Descreva sua rotina matinal:',
    maxWords: 20,
    correctAnswer: 'Texto livre',
  ...
  // A2 - Escrita elementar
  {
    ...
    level: 'A2',
    category: 'writing',
    question: 'Escreva sobre seu final de semana:',
    maxWords: 20,
    correctAnswer: 'Texto livre',
...

  {
    ...
    level: 'A2',
    category: 'writing',
    question: 'Descreva seu melhor amigo ou amiga:',
    maxWords: 20,
    correctAnswer: 'Texto livre',
  ...
  // B1 - Escrita intermediária
  {
    ...
    level: 'B1',
    category: 'writing',
    question: 'Escreva sobre uma viagem memorável:',
    maxWords: 20,
    correctAnswer: 'Texto livre',
...

  {
    ...
    level: 'B1',
    category: 'writing',
    question: 'Solicite informações sobre um curso:',
    maxWords: 20,
    correctAnswer: 'Texto livre',
  ...
  // B2 - Escrita avançada intermediária
  {
    ...
    level: 'B2',
    category: 'writing',
    question: 'Sua opinião sobre redes sociais:',
    maxWords: 20,
    correctAnswer: 'Texto livre',
...

  {
    ...
    level: 'B2',
    category: 'writing',
    question: 'Por que você quer este emprego?',
    maxWords: 20,
    correctAnswer: 'Texto livre',
  ...
  // C1 - Escrita avançada
  {
    ...
    level: 'C1',
    category: 'writing',
    question: 'Como a tecnologia está mudando o trabalho?',
    maxWords: 20,
    correctAnswer: 'Texto livre',
