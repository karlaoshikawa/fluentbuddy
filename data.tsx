...
export const EXERCISE_BANK: Exercise[] = [
  ...
  // B1 - Escrita intermediária
  {
    ...
    level: 'B1',
    category: 'writing',
    question: 'Escreva sobre uma viagem memorável que você fez. Descreva o lugar, o que você fez e por que foi especial:',
    minWords: 60,
    maxWords: 80,
    correctAnswer: 'Texto livre',
...

  {
    ...
    level: 'B1',
    category: 'writing',
    question: 'Escreva um e-mail formal solicitando informações sobre um curso de inglês:',
    minWords: 50,
    maxWords: 70,
    correctAnswer: 'Texto livre',
  ...
  // B2 - Escrita avançada intermediária
  {
    ...
    level: 'B2',
    category: 'writing',
    question: 'Escreva sua opinião sobre o impacto das redes sociais na sociedade moderna. Apresente argumentos a favor e contra:',
    minWords: 80,
    maxWords: 100,
    correctAnswer: 'Texto livre',
...

  {
    ...
    level: 'B2',
    category: 'writing',
    question: 'Escreva uma carta de motivação para uma vaga de emprego:',
    minWords: 70,
    maxWords: 90,
    correctAnswer: 'Texto livre',
  ...
  // C1 - Escrita avançada
  {
    ...
    level: 'C1',
    category: 'writing',
    question: 'Escreva um ensaio analisando como a tecnologia está mudando o mercado de trabalho e quais habilidades serão essenciais no futuro:',
    minWords: 100,
    maxWords: 120,
    correctAnswer: 'Texto livre',
